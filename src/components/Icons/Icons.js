...
// footer
export const FooterIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
// close login form
export const CloseLoginIcon = ({ width = '2.5rem', height = '2.5rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
// back login form
export const BackLoginIcon = ({ width = '2.5rem', height = '2.5rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
// Sign up
export const SquareIcon = ({ width = '1.4rem', height = '1.4rem', className, onClick }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
// show hide passwords
export const HidePasswordIcon = ({ width = '2rem', height = '2rem', className, onClick }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const ShowPasswordIcon = ({ width = '2rem', height = '2rem', className, onClick }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const MuteVolumeIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
export const UnmuteVolumeIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
// section action bar
export const ButtonContentIcon = ({ width = '2.4rem', height = '2.4rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
...
// share preview
export const RepostIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
export const SendToFriendsIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
export const ShareToFacebookIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
// icon more
export const ArrowBottomIcon = ({ width = '2.6rem', height = '2.6rem', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
// get app
export const ComputerIcon = ({ width = '2.1rem', height = '2.1rem', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
...
export const PhoneIcon = ({ width = '2.1rem', height = '2.1rem', className }) => (
  <svg
    width={width}
    height={height}
    className={className}
